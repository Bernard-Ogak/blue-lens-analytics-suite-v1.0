...
while ( have_posts() ) :
	...
	<div class="single-exp-hero py-20 bg-safari-green text-white relative">
		<div class="site-container max-w-4xl text-center relative z-10">
			<span class="badge-gold mb-3 inline-block"><?php esc_html_e( 'Signature Experience', 'bo-safari-theme' ); ?></span>
